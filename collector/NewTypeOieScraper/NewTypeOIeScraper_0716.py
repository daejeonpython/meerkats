...
def get_oie_data():
    ...
    def makeWantLinkNumberList():
        ...
        while howTorotate:
            ...
            data = {"pageNumber":str(num),"pageSize":100,"searchText":"",
            ...
            num += 1
            print(f'{num}번째 회차입니다. 이번 건수는 {len(_weekList_)}이며 총 wantlinknumber:{len(want_linknumbers)}개가 쌓였습니다')

        return want_linknumbers

    totalList = makeWantLinkNumberList()
