...
def translate_oie_reports(oie_reports):
    ...
    Dict = {"Link number": "링크 번호",
         ...
         "Vaccination in response to the outbreak": "발생대응예방접종",
         ...
         "Official disposal of carcasses": "사체·부산물·폐기물 공식처리",
         "Process to inactivate the pathogenic agent": "생산물 또는 부산물 내 병원체 불활화 처리",
         "Stamping out":"살처분",
         ...
         "Vaccination permitted": "백신접종 허용(백신이 있는 경우)",
    ...
    want_columns = ['Link number',
                    ...
                    'Official disposal of carcasses',
                    'Process to inactivate the pathogenic agent',
                    'Stamping out',
    ...
    header_kr = ['링크 번호', '질병', '국가', '혈청형', '보고일', '건수', '발생일',
                 ...
                 '백신접종 허용', '백신접종 금지', '감염동물 미치료', '감염동물 치료', '도축*', '세부내역', '원인체', '리포트 번호', '보고서 ID']
