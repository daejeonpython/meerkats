...
class LSTMPredictor(nn.Module):
    def __init__(self, n_features=1, n_hidden=256, n_layers=2, seq_len=10):
        ...
        self.hidden_states = torch.zeros(self.n_layers, self.seq_len, self.n_hidden)
        self.cell_states = torch.zeros(self.n_layers, self.seq_len, self.n_hidden)
